...
const defaultOrigin = new ObservablePoint.ObservablePoint(null);
...
class Container extends EventEmitter {
  ...
  set pivot(value) {
    if (this._pivot === defaultPivot) {
      ...
      if (this._origin !== defaultOrigin) {
        warn.warn(`Setting both a pivot and origin on a Container is not recommended. This can lead to unexpected behavior if not handled carefully.`);
      }
    }
  ...
  get origin() {
    if (this._origin === defaultOrigin) {
      this._origin = new ObservablePoint.ObservablePoint(this, 0, 0);
    }
    return this._origin;
  }
  set origin(value) {
